...
| Layer | Skills |
|---|---|
| Agentic core | `environment-recon`, `execution-discipline`, `verification-gates` |
| Dev | `api-design`, `postgres-patterns`, `fullstack-delivery`, `systematic-debugging` |
| Operations | `server-ops-safety`, `network-diagnosis` |
