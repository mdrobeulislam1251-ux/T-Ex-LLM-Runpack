# Outboundrix · T-Ex LLM — The Full Company Runpack

*(repo: T-Ex-LLM-Runpack — the single combined version of the agent product.
Confirmed commercial identity: **Outboundrix**, the platform company behind
Trusted Leads, Lead Gen Jay, and Consulti; **T-Ex LLM** stays the engine name —
naming research, About copy, and value-discipline rules in
[`strategy/brand-identity.md`](strategy/brand-identity.md).)*
